...
The model picker lists every enabled LLM model in your workspace. Three models are available by default:

- **Claude Sonnet** — Anthropic's flagship model with strong reasoning and vision
- **GPT-5.4 Mini** — OpenAI's compact model, fast and cost-effective for everyday tasks
- **Gemini 3.1 Flash Lite** — Google's lightweight Gemini variant, optimized for fast responses

Your workspace administrator can add more models — any OpenAI-compatible endpoint, additional Anthropic or Gemini variants, or custom hosted LLMs — through the Node Builder.
