---
title: "Compare Knouds plans: Free, Creator, Pro, Business"
...
<Note>
**Enterprise** is available as a custom contract for high-volume teams. It includes unlimited rate limits, custom credit allowances, and dedicated support. Contact us at [knouds.ai](https://knouds.ai) to discuss.
</Note>
...
On Creator, Pro, Business, and Enterprise, your credit balance is reset to your plan's allowance each time your subscription renews. The renewal is handled automatically via Stripe. You can see the date of your last refresh in **Settings → Billing**.
